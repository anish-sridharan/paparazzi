/* Automatically generated by gen_abi from /home/mariano/paparazzi/conf/abi.xml */
/* Version v5.17_devel-100-gb91a7b3a6 */
/* Please DO NOT EDIT */
...
typedef void (*abi_callbackOPTICAL_FLOW)(uint8_t sender_id, uint32_t stamp, int16_t flow_x, int16_t flow_y, int16_t flow_der_x, int16_t flow_der_y, float quality, float size_divergence, float value);
...
static inline void AbiSendMsgOPTICAL_FLOW(uint8_t sender_id, uint32_t stamp, int16_t flow_x, int16_t flow_y, int16_t flow_der_x, int16_t flow_der_y, float quality, float size_divergence, float value) {
  abi_event* e;
  ABI_FOREACH(abi_queues[ABI_OPTICAL_FLOW_ID],e) {
    if (e->id == ABI_BROADCAST || e->id == sender_id) {
      abi_callbackOPTICAL_FLOW cb = (abi_callbackOPTICAL_FLOW)(e->cb);
      cb(sender_id, stamp, flow_x, flow_y, flow_der_x, flow_der_y, quality, size_divergence, value);
    }
  }
}
