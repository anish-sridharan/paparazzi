...
# endif
static abi_event color_detection_ev , optical_flow_ev;
...
void mav_exercise_periodic(void) {
  ...
  */
  ...
  if(div_1>div_thresh) navigation_state = OBSTACLE_FOUND;
  ...
  switch (navigation_state) {
    case SAFE:
     ...
     if (!InsideObstacleZone(stateGetPositionEnu_i()->x , stateGetPositionEnu_i()->y )) {
    ...
    case SEARCH_FOR_SAFE_HEADING:
      ...
      if (obstacle_free_confidence >= 2){
        //guidance_h_set_guided_heading(0.5f);
        navigation_state = SAFE; 
       }
      */
      /*
    ...
    case OUT_OF_BOUNDS:
      ...
      if (InsideObstacleZone(stateGetPositionEnu_i()->x , stateGetPositionEnu_i()->y )) {
        ...
        //guidance_h_set_guided_heading(3.14f);
        //increase_nav_heading(oob_haeding_increment);
        navigation_state = SAFE;
      }
      */
