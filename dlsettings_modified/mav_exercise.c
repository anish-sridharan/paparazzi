...
void mav_exercise_periodic(void) {
  ...
  */
  ...
  int32_t color_count_threshold = 100 * oa_color_count_frac * front_camera.output_size.w * front_camera.output_size.h;
  ...
  switch (navigation_state) {
    case SAFE:
      ...
      guidance_h_set_guided_heading_rate(-Kp * of_diff - Kd * (of_diff - of_diff_prev));
