/* This file has been generated by gen_flight_plan from /home/denesh/paparazzi/conf/flight_plans/tudelft/course_orangeavoid_cyberzoo.xml */
...
#define WAYPOINTS_ENU { \
 ...
 {-5.95, 1.39, 1.00}, /* ENU in meters  */ \
 {1.09, 6.03, 1.00}, /* ENU in meters  */ \
 {5.76, -1.14, 1.00}, /* ENU in meters  */ \
 {-1.22, -5.34, 1.00}, /* ENU in meters  */ \
 {-5.51, 1.29, 1.00}, /* ENU in meters  */ \
 {1.08, 5.45, 1.00}, /* ENU in meters  */ \
 {5.45, -1.12, 1.00}, /* ENU in meters  */ \
};
#define WAYPOINTS_LLA { \
 ...
 {.lat=519906465, .lon=43767024, .alt=1000}, /* 1e7deg, 1e7deg, mm (above NAV_MSL0, local msl=45.11m) */ \
 {.lat=519906882, .lon=43768049, .alt=1000}, /* 1e7deg, 1e7deg, mm (above NAV_MSL0, local msl=45.11m) */ \
 {.lat=519906237, .lon=43768728, .alt=1000}, /* 1e7deg, 1e7deg, mm (above NAV_MSL0, local msl=45.11m) */ \
 {.lat=519905860, .lon=43767712, .alt=1000}, /* 1e7deg, 1e7deg, mm (above NAV_MSL0, local msl=45.11m) */ \
 {.lat=519906456, .lon=43767088, .alt=1000}, /* 1e7deg, 1e7deg, mm (above NAV_MSL0, local msl=45.11m) */ \
 {.lat=519906829, .lon=43768047, .alt=1000}, /* 1e7deg, 1e7deg, mm (above NAV_MSL0, local msl=45.11m) */ \
 {.lat=519906239, .lon=43768683, .alt=1000}, /* 1e7deg, 1e7deg, mm (above NAV_MSL0, local msl=45.11m) */ \
};
#define WAYPOINTS_LLA_WGS84 { \
 ...
 {.lat=519906465, .lon=43767024, .alt=46110}, /* 1e7deg, 1e7deg, mm (above WGS84 ref ellipsoid) */ \
 {.lat=519906882, .lon=43768049, .alt=46110}, /* 1e7deg, 1e7deg, mm (above WGS84 ref ellipsoid) */ \
 {.lat=519906237, .lon=43768728, .alt=46110}, /* 1e7deg, 1e7deg, mm (above WGS84 ref ellipsoid) */ \
 {.lat=519905860, .lon=43767712, .alt=46110}, /* 1e7deg, 1e7deg, mm (above WGS84 ref ellipsoid) */ \
 {.lat=519906456, .lon=43767088, .alt=46110}, /* 1e7deg, 1e7deg, mm (above WGS84 ref ellipsoid) */ \
 {.lat=519906829, .lon=43768047, .alt=46110}, /* 1e7deg, 1e7deg, mm (above WGS84 ref ellipsoid) */ \
 {.lat=519906239, .lon=43768683, .alt=46110}, /* 1e7deg, 1e7deg, mm (above WGS84 ref ellipsoid) */ \
};
  ...
  if (_y <= 1.3) {
    if (_y <= -1.0) {
      if (_y <= -5.7) {
        ...
        float dy = _y - -1.0;
        return (-4.4+dy*-0.698413<= _x && _x <= 5.8+dy*1.495671);
      }
    } else {
      float dy = _y - 1.3;
      return (-6.0+dy*-0.698413<= _x && _x <= 4.2+dy*-0.677966);
    }
  } else {
    if (_y <= 6.0) {
      float dy = _y - 6.0;
      return (1.0+dy*1.457023<= _x && _x <= 1.0+dy*-0.677966);
    } else {
      return FALSE;
    }
  }
  ...
  if (_y <= 1.2) {
    if (_y <= -1.0) {
      if (_y <= -5.4) {
        ...
        float dy = _y - -1.0;
        return (-4.0+dy*-0.673282<= _x && _x <= 5.5+dy*1.518433);
      }
    } else {
      float dy = _y - 1.2;
      return (-5.5+dy*-0.673282<= _x && _x <= 3.9+dy*-0.691834);
    }
  } else {
    if (_y <= 5.5) {
      float dy = _y - 5.5;
      return (1.0+dy*1.521028<= _x && _x <= 1.0+dy*-0.691834);
    } else {
      return FALSE;
    }
  }
